...
import { FormControl, StepForm, Content } from 'components'
import {
  initialPolicy,
  Prefixes,
  Statuses,
...
export default function ({ type = '', close }) {
  ...
  return (
    <Formik
      ...
      validationSchema={createMotorPolicySchema({ I1Ismain, I2Ismain })}
      onSubmit={async (
        {
          Prefix,
          Status,
        ...
        return (
          <StepForm {...props}>
            ...
            <div>
              ...
              <br />
              <FormControl.FieldSet>
                <FormControl.Legend>Usage and Renewal Details</FormControl.Legend>
                <FormControl.ResponsiveSection cols={3}>
                  <FormControl.Select
