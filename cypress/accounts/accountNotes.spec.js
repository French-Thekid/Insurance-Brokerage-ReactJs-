let p = {
  section: 'General',
  content: `Test note with some content generated_${Math.floor(
    Math.random() * 99
  ) + 1}`,
}
...
let c = {
  section: 'General',
  content: `Updated Test note with some content generated_${Math.floor(
    Math.random() * 99
  ) + 1}`,
}
...
context('Actions', () => {
  ...
  it('Signs in to create a note in accounts', () => {
